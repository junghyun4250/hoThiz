  ...
  <div class="container">
   ...
   <table border=1 align="center">
      ...
      <tr>
         ...
         <td align="left"> <input type=text value="${msg.message_send_member }" name="message_send_member" style="width: 100%;" disabled> </td>
      </tr>
      <tr>
         <td align="center"  class="trb">제목</td>
         <td align="left"><input type=text value="${msg.message_type }" name="message_type" id="message_type" style="width: 100%;" disabled /></td>
      </tr>
      <tr>
         <td align="center"  class="trb">내용</td>
         <td><textarea rows="20" cols="60" name="message_content" 
               id="message_content" disabled >${msg.message_content }</textarea>
            <div id="reply"></div>
         </td>
      </tr>         
      <tr>
      ...
      <tr>
         <td colspan="2" align="center"><!-- 로그인 유저와 글 작성 아이디가 같다면 수정 삭제 보여줌  -->
            <c:if test="${userId == msg.member_email }">
               
               <input type=button value="삭제하기" onclick=
                  "location.href='boardDelete?message_num=${msg.message_num}'">
            </c:if>
            <c:if test="${userId == msg.message_receive_member }">
            <input type=button value="답글쓰기" onclick="location.href='boardReplyView?message_num=${msg.message_num}'">
            </c:if>
